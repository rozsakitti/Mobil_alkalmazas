...
import com.example.kittisapplication.databinding.ActivityQuizQuestionsBinding
...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding: ActivityQuizQuestionsBinding =
            DataBindingUtil.setContentView(this, R.layout.activity_quiz_questions)

        binding.tvQuestion.text = "What car brand do you see in the picture?"
